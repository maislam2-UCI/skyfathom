...
const SHELL = ["./", "./index.html", "./app.js", "./manifest.webmanifest", "./ui/app.css", "./ui/panels.js",
  ...
  "./modes/planetarium.js", "./modes/ar.js", "./modes/planner.js", "./modes/framing.js", "./modes/darksky.js"];
const DATA = ["./vendor/astronomy.browser.min.js", "./assets/icon.svg", "./assets/icon-192.png", "./assets/icon-512.png", "./assets/milkyway.jpg",
...
const isDataUrl = (p) => p.includes("/data/") || p.includes("/vendor/") || p.includes("/assets/");
