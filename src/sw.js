...
const SHELL = ["./", "./index.html", "./app.js", "./manifest.webmanifest", "./ui/app.css", "./ui/panels.js",
  ...
  "./render/sky.js", "./sensors/gps.js", "./sensors/imu.js", "./sensors/camera.js", "./weather.js",
  "./modes/planetarium.js", "./modes/ar.js", "./modes/planner.js", "./modes/framing.js",
...
const LAZY = ["./data/stars-faint.json", "./data/dso-full.json"];
...
self.addEventListener("fetch", (e) => {
  ...
  const isData = url.pathname.includes("/data/") || url.pathname.includes("/vendor/");
  e.respondWith((async () => {
    const c = await caches.open(VERSION);
    if (isData) {
