...
| **Sky darkness forecast** | Hour-by-hour sky brightness tonight from your Bortle level, the Moon's actual brightness and altitude, twilight and cloud back-scatter: mag/arcsec², naked-eye limit, darkest hour, best window, Milky Way visibility |
| **Aurora** | Live NOAA Kp and 3-day forecast, your geomagnetic latitude and the Kp needed to see aurora there, OVATION probability on demand, and alerts when the forecast crosses your threshold |
...
| **Comets** | Every comet the Minor Planet Center predicts brighter than magnitude 14 this year, positioned from its orbital elements with a Kepler/Barker/hyperbolic solver, drawn on the map with an anti-sunward tail, searchable, with distance, elongation, perihelion, period and peak-brightness details; elements refresh daily |
| **Eclipses** | Solar eclipses visible from your exact spot with local start, maximum, totality and end times and the percentage of the Sun covered; lunar eclipses with all contact times and whether the Moon is up; next solar eclipses worldwide; Mercury/Venus transits; show-in-sky and calendar export |
| **All-sky view** | One tap shows the whole dome with the horizon as a circle and the zenith at the centre |
| **Solar System** | Top-down orrery with the real orbits of all eight planets and Pluto from the ephemeris, positions for any date within ±2 years via a slider or playback, inner/outer/log scaling, Earth-to-planet sight line with distances, elongation and opposition/conjunction status |
| **Earth view** | A draggable Earth globe with the live day/night terminator (Blue Marble day side, Black Marble city lights at night), your position, the sub-solar and sub-lunar points, and the ISS with its next 90 minutes of ground track; plus a live Solar-System distance table |
| **Planet facts & moons** | Every planet card shows distance from Earth and Sun, light time, diameter, gravity, day and year length, temperature, moon count and major moons; Jupiter's Galilean moons are drawn at their real positions on the map (tap them for details) |
| **3D planets & Moon** | Zoom in (down to a 2.4′ field) or tap Close-up on any planet, the Moon or the Sun: a shaded, textured globe with the real phase and Sun direction, pole tilt and rotation from the IAU rotation elements, Saturn's rings at the ephemeris tilt, and the Moon's actual libration; the view follows the body as it moves |
